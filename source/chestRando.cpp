...
namespace mod
{
	void ChestRandomizer::generate()
	{
		...
		u8* tempShuffleDungeonArray = array::shuffleDungeonArray;
		u32 shuffleDungeonArrayTotalElements = sizeof(array::shuffleDungeonArray) / sizeof(array::shuffleDungeonArray[0]);
		tools::fillArrayIncrement(tempShuffleDungeonArray, shuffleDungeonArrayTotalElements, 0x1);

		tools::shuffleByteArray(tempShuffleDungeonArray, shuffleDungeonArrayTotalElements);

		char txt[50];
		snprintf(txt, 50, "0 = %i", array::shuffleDungeonArray[0x0]);
