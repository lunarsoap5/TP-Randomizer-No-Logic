...
namespace mod::game_patch
{
	...
	void accessDesert()
	{
		if (Singleton::getInstance()->isDesertAccessEnabled == 1 || tools::checkItemFlag(ItemFlags::Shadow_Crystal))
		{
			return;
		}
		else
	...
	void skipTextAndCS()
	{
		...
		if (Singleton::getInstance()->isEarlyToTEnabled == 1)
		{
			allAreaNodesPtr->Sacred_Grove.unk_0[0x17] |= 0x10; //SG Portal
			allAreaNodesPtr->Sacred_Grove.unk_0[0x9] |= 0x70; //ToT Stairs
			allAreaNodesPtr->Sacred_Grove.unk_0[0xB] |= 0x10; //Pushed block as human
		}
		...
		if (Singleton::getInstance()->isGMStoryPatch == 1)
		{
			...
			allAreaNodesPtr->Eldin.unk_0[0x14] |= 0x10; //barnes sells bombs
		}
		...
		if (Singleton::getInstance()->isCartEscortSkipEnabled == 1)
		{
			...
			allAreaNodesPtr->Eldin.unk_0[0x17] |= 0x40;//remove rock in graveyard
			allAreaNodesPtr->Eldin.unk_0[0x16] |= 0x40;
		}
		...
		if (Singleton::getInstance()->isAllPortalsUnlocked == 1)
		{
			...
			allAreaNodesPtr->Sacred_Grove.unk_0[0x17] |= 0x10; //SG Portal
			allAreaNodesPtr->Snowpeak.unk_0[0x9] |= 0x20;//give Snowpeak Portal
			allAreaNodesPtr->Gerudo_Desert.unk_0[0x9] |= 0x20;//give Desert Portal
			allAreaNodesPtr->Gerudo_Desert.unk_0[0xE] |= 0x1;//give Mirror Chamber Portal
		}
